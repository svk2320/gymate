      ...
      <section>
        ...
        <div className="py-[10rem] container gap-16 page-padding grid grid-cols-[64fr_35fr] md1000:grid-cols-1 md1000:gap-32">
          ...
          <div className="flex flex-col gap-28">
            <BlogCard img={Img1} date="22.03.2022" title="Yoga For Everyone in 2022" />
            <BlogCard
              img={Img2}
              date="26.03.2022"
              title="Getting Back Into CrossFit After Vacation"
            />
            <BlogCard img={Img3} date="13.09.2022" title="Meet Fitness Ambassador Grace" />
            <BlogCard img={Img4} date="28.06.2023" title="The Best are European Materls Direct" />
            <BlogCard
              img={Img5}
